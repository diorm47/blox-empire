...
function Withdraw() {
  ...
  return (
    <div className="inventory_page main_page_styles withdraw_page">
      <div
        className={
      ...
      >
        ...
        <div className="inventory_top_actions">
          ...
          />
          <div className="withdraw_select">
            <div
              className="withdraw_selected"
              onClick={() => setDropdown(!dropdown)}
            >
              <p className="main_p_style">High to Low</p>
              <ArrowDown />
            </div>
            {dropdown ? (
              <div
                className="dropwo_menu"
                onClick={() => setDropdown(!dropdown)}
              >
                <p className="main_p_style px">High to Low</p>
                <p className="main_p_style">Low to High</p>
              </div>
            ) : (
              ""
            )}
